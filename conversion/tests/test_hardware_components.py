...
def setup_local_obj_changer(obj_changer_id, n_positions=None,
                            ...
                            prefs_path=None, auto_focus_id=None):
...
@pytest.mark.parametrize('name, path, prefs_path, expected',
                         [('WellTile_10x_true.czexp',
                          ...
                          ('test_communication.exp.prefs',
                           ...
                           True),
                          ('test_communication.exp.prefs',
                           'test_data/Experiment Setup/test_communication.exp.prefs',
                           'test_data/preferences_ZSD_test.yml',
                           False),
                          ('WellTile_10x_true.czexp',
                           'test_data/SlideBook 6.0/WellTile_10x_true.czexp',
                           'test_data/preferences_3i_test.yml',
                           False)])
...
@pytest.mark.parametrize('name, path, prefs_path, expected',
                         [('WellTile_10x_true.czexp',
                          ...
                          ('WellTile_10x_false.czexp',
                           'test_data/Experiment Setup/WellTile_10x_false.czexp',
                           'test_data/preferences_ZSD_test.yml',
                           False),
                          ('test_communication.exp.prefs',
                           'test_data/Experiment Setup/test_communication.exp.prefs',
...
@pytest.mark.skipif(skip_all_tests, reason='Exclude all tests')
@pytest.mark.parametrize('name, path, prefs_path, x, y, z, expected',
                         [('WellTile_10x_true.czexp',
                           'test_data/Experiment Setup/WellTile_10x_true.czexp',
                           'test_data/preferences_ZSD_test.yml',
                          ...
                          ('test_communication.exp.prefs',
                           'test_data/Experiment Setup/test_communication.exp.prefs',
                           'test_data/preferences_ZSD_test.yml', 1000, 1000, 3,
                           'ExperimentNotExistError'),
                          ('test_communication.exp.prefs',
                           'test_data/SlideBook 6.0/test_communication.exp.prefs',
                           'test_data/preferences_3i_test.yml', 1000, 1000, 3,
                           'HardwareCommandNotDefinedError')])
...
@pytest.mark.parametrize('name, path, prefs_path, expected',
                         [('WellTile_10x_true.czexp',
                           'test_data/Experiment Setup/WellTile_10x_true.czexp',
                           'test_data/preferences_ZSD_test.yml', 1),
                          ('test_communication.exp.prefs',
                           'test_data/Experiment Setup/test_communication.exp.prefs',
                           'test_data/preferences_ZSD_test.yml',
                           'ExperimentNotExistError'),
...
@pytest.mark.parametrize('name, path, prefs_path, expected',
                         [('WellTile_10x_true.czexp',
                           'test_data/Experiment Setup/WellTile_10x_true.czexp',
                           'test_data/preferences_ZSD_test.yml',
                           'test_data/Experiment Setup/focus_settings.xml'),
                          ('test_communication.exp.prefs',
                           'test_data/Experiment Setup/test_communication.exp.prefs',
                           'test_data/preferences_ZSD_test.yml',
                           'ExperimentNotExistError'),
...
def test_is_safe_move_from_to(safety_id, safe_verts1, safe_area_id1, z_max1,
    ...
    path = mpl_path(xy)
    area_id = "Compound"
    result = safety.is_safe_move_from_to(area_id, path, z_max_pos, x_cur, y_cur,
                                         z_cur, x_tar, y_tar, z_tar, verbose=False)
    assert result == expected
...
def test_show_safe_areas(mock_show, safety_id, safe_verts1, safe_area_id1, z_max1,
                         safe_verts2, safe_area_id2, z_max2, xy, point):
    safety = setup_local_safety(safety_id)
    safety.add_safe_area(safe_verts1, safe_area_id1, z_max1)
...
@pytest.mark.skipif(skip_all_tests, reason='Exclude all tests')
@pytest.mark.parametrize(("camera_id, pixel_size, pixel_number, pixel_type, name, "
                          "detector_type, manufacturer, model, live_exp, set_exp"),
                         [('Camera2 (Left)', (None, None), (None, None), None,
                           None, 'generic', None, None, False,
                          ...
                          ('Camera1 (Back)', (6.5, 6.5), (2048/2, 2048/2),
                           ...
                           ("{'aics_Manufacturer': 'Hamamatsu', "
                            "'aics_PhysicalSizeY': 6.5, 'aics_PhysicalSizeX': 6.5, "
                            "'aics_Model': None, 'aics_PhysicalSizeXUnit': 'mum', "
                            "'aics_SizeX': 1024, 'aics_SizeY': 1024, "
                            "'aics_PixelType': <type 'numpy.int32'>, "
                            "'aics_cameraID': 'Camera1 (Back)', "
                            "'aics_PhysicalSizeYUnit': 'mum', "
                            "'aics_Type': 'sCMOS'}"))])
def test_get_information_camera(camera_id, pixel_size, pixel_number, pixel_type,
                                name, detector_type, manufacturer, model, live_exp,
                                set_exp):
    camera = setup_local_camera(camera_id, pixel_size, pixel_number, pixel_type,
                                name, detector_type, manufacturer, model)
    info = camera.get_information(None)

    assert info['live'] == live_exp and str(info['settings']) == set_exp
...
def test_initialize_stage(stage_id, software, safe_area, safe_position,
                          objective_changer, prefs_path, default_experiment,
                          expected):
    control_software = setup_local_control_software(software)
    com_object = control_software.connection
    stage = setup_local_stage(stage_id, safe_area, safe_position,
                              objective_changer, prefs_path, default_experiment)
...
def test_get_information_stage(stage_id, software, expected):
    ...
    result = str(stage.get_information(control_software.connection))
                          ...
                          ('6xMotorizedNosepiece', 'ZEN Blue Dummy', 6,
                           {'Plan-Apochromat 10x/0.45':
                            ...
                            {'x_offset': 44,
                             ...
                             'autofocus': 'DefiniteFocus2'}},
                           'Plan-Apochromat 20x/0.8 M27',
                           'test_data/preferences_ZSD_test.yml', [], 'Plate',
                           None, True),
                          ('6xMotorizedNosepiece', 'ZEN Blue Dummy', 6,
                           {'Plan-Apochromat 10x/0.45':
                            {'x_offset': -19,
...
def test_initialize_obj_changer(objective_changer_id, software, positions,
                                ...
                                action_list, ref_object_id, auto_focus_id,
                                expected):
    control_software = setup_local_control_software(software)
    obj_changer = setup_local_obj_changer(objective_changer_id, positions,
                                          objectives, ref_obj_changer,
                                          prefs_path, auto_focus_id)
...
@pytest.mark.skipif(skip_all_tests, reason='Exclude all tests')
@pytest.mark.parametrize(("objective_changer_id, positions, expected"),
                         ...
                         [('6xMotorizedNosepiece', 'ZEN Blue Dummy', None, None,
                          ...
                          ('6xMotorizedNosepiece', 'ZEN Blue Dummy', 6,
                           ...
                           {'magnification': 10,
                            ...
                            'experiment': 'WellTile_10x_true'})])
def test_get_information_obj_changer(objective_changer_id, software, positions,
                                     objectives, expected):
    control_software = setup_local_control_software(software)
    obj_changer = setup_local_obj_changer(objective_changer_id, positions,
                                          objectives)
                          ...
                          ('6xMotorizedNosepiece', 'ZEN Blue Dummy', 6,
                           {'Plan-Apochromat 10x/0.45':
                            ...
                            {'x_offset': 44,
                             ...
                             'camera': 'Camera1 (back)',
                             'autofocus': 'DefiniteFocus2'}},
                           1, 2, 3, 'Plan-Apochromat 10x/0.45',
                           {'x_offset': 1,
                            'y_offset': 2,
                            'z_offset': 3,
                            'magnification': 10,
                            ...
                            'camera': 'Camera1 (back)',
                            'autofocus': 'DefiniteFocus2'})])
def test_update_objective_offset(objective_changer_id, software, positions, objectives,
                                 x_off, y_off, z_off, objective_name, expected):
    control_software = setup_local_control_software(software)
...
def test_initialize_focus_drive(focus_id, software, max_load_position,
    ...
    try:
        focus_drive.initialize(control_software.connection,
                               action_list=action_list, verbose=False, test=True)
                         ...
                         [('MotorizedFocus', 'ZEN Blue Dummy', 500, 100,
                          ...
                          ('MotorizedFocus', 'ZEN Blue Dummy', None, None,
                           ...
                           {'load_position': None, 'work_position': None,
                            ...
                            'z_focus_offset': None})])
def test_get_information_focus_drive(focus_id, software, max_load_position,
                                     min_work_position, auto_focus_id, obj_changer_id,
                                     objectives, prefs_path, action_list, expected):
    control_software = setup_local_control_software(software)
    focus_drive = setup_local_focus_drive(focus_id, max_load_position,
                                          min_work_position, auto_focus_id,
                                          obj_changer_id, prefs_path)
    if obj_changer_id:
        obj_changer = setup_local_obj_changer(obj_changer_id, objectives=objectives,
...
def test_goto_load(focus_id, software, max_load_position, min_work_position,
    ...
    control_software = setup_local_control_software(software)
    focus_drive = setup_local_focus_drive(focus_id, max_load_position,
                                          min_work_position, prefs_path=prefs_path)
                          ...
                          ('DefiniteFocus2', 'ZEN Blue Dummy',
                           ...
                           {'Dummy Objective':
                            {'x_offset': -19,
                             ...
                             'autofocus': 'DefiniteFocus2'}},
                           'Not defined')])
def test_get_init_experiment(auto_focus_id, software, obj_changer_id,
                             positions, objectives, expected):
    control_software = setup_local_control_software(software)
                          ...
                          ('DefiniteFocus2', 'ZEN Blue Dummy',
                           ...
                           {'Dummy Objective':
                            {'x_offset': -19,
                             ...
                             'autofocus': 'DefiniteFocus2'}},
                           'test_data/preferences_ZSD_test.yml',
                           'Camera1 (Back)', (6.5, 6.5), (1024, 1024), numpy.int32,
                           ['find_surface'], None)])
def test_initialize_autofocus(auto_focus_id, software, obj_changer_id,
                              positions, objectives, prefs_path, camera_id,
                              pixel_size, pixel_number, pixel_type, action_list,
                              expected):
    control_software = setup_local_control_software(software)
    obj_changer = setup_local_obj_changer(obj_changer_id, positions, objectives)
...
@pytest.mark.parametrize(("auto_focus_id, software, obj_changer_id, "
                         ...
                         [('DefiniteFocus2', 'ZEN Blue Dummy',
                          ...
                          ('DefiniteFocus2', 'ZEN Blue Dummy',
                           ...
                           {'Dummy Objective':
                            {'x_offset': -19,
                             ...
                             'autofocus': 'DefiniteFocus2'}},
                           'None',
                           {'use': False, 'experiment': 'WellTile_10x_true',
                          ...
                          ('DefiniteFocus2', 'ZEN Blue Dummy',
                           ...
                           'Camera1 (Back)',
                           {'use': False,
                            'experiment': 'WellTile_10x_true', 'delta_z': None,
                            'reference_object_id': None, 'camera': 'Camera1 (Back)',
                            'initial_focus': None, 'live_mode': True})])
def test_get_information_autofocus(auto_focus_id, software, obj_changer_id,
                                   positions, objectives, camera_id, expected):
    control_software = setup_local_control_software(software)
    obj_changer = setup_local_obj_changer(obj_changer_id, positions, objectives)

    autofocus = setup_local_autofocus(auto_focus_id, default_camera=camera_id,
...
@pytest.mark.skipif(skip_all_tests, reason='Exclude all tests')
@pytest.mark.parametrize(("auto_focus_id, settings, expected"),
                         ...
                         [('DefiniteFocus2', 'ZEN Blue Dummy',
                           ...
                           {'Dummy Objective':
                            {'x_offset': -19,
                             ...
                             'camera': 'Camera1 (back)',
                             'autofocus': 'DefiniteFocus2'}},
                             'PlateHolder', 'test_data/preferences_ZSD_test.yml',
                           False, False, '', '', None),
                          ('DefiniteFocus2', 'ZEN Blue Dummy',
                           '6xMotorizedNosepiece', 6,
                           {'Dummy Objective':
                          ...
                          ('DefiniteFocus2', 'ZEN Blue Dummy',
                           ...
                           {'Dummy Objective':
                            {'x_offset': -19,
                             ...
                             'autofocus': 'DefiniteFocus2'}},
                             'PlateHolder', 'test_data/preferences_ZSD_test.yml',
                           True, True, 'Dummy Objective', 'Dummy Objective', 100)])
def test_recall_focus(auto_focus_id, obj_changer_id, software, positions,
                      objectives, ref_object_id, prefs_path, use_autofocus,
                      autofocus_ready, df_objective, obj_name, expected):
    control_software = setup_local_control_software(software)
    obj_changer = setup_local_obj_changer(obj_changer_id, positions,
                                          objectives, prefs_path=prefs_path,
                                          auto_focus_id=auto_focus_id)
...
@pytest.mark.skipif(skip_all_tests, reason='Exclude all tests')
@pytest.mark.parametrize(("pump_id, seconds, port, baudrate, expected"),
                         [('BraintreeScientific', 5, 'COM1', 19200,
                           ('COM1', 19200)),
                          ('BraintreeScientific', None, None, None,
                           (None, None)),
                          ('BraintreeScientific', None, 443, 'test',
                           (443, 'test'))])
