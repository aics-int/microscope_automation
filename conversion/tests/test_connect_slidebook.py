...
@pytest.fixture
def connection_object(cmd_url='http://127.0.0.1:5000',
...
def test_load_image(connection_object, image, meta_data):
    ...
    return_image = connection_object.load_image(image)
    assert np.array_equal(return_image, image)
