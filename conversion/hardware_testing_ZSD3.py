...
def test_set_zero(sample_object, test_settings, image_settings):  
    ...
    input('Please focus to set z-zero for slide')
    ...
    for pos in range(2):
        ...
        input('Please select center of tile scan')
    ...
    for experiment_type in test_settings['magnification_experiments']:
        ...
        for cell_object in samples_list:
            ...
            print(('aics_imageAbsPosZ(focality_corrected): {}'.format(images[0].get_meta('aics_imageAbsPosZ(focality_corrected)'))))
