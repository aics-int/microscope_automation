...
def FixedPatternCorrection(image, blackReference):
    ...
    To correct the image we use a reference image acquired under the same conditions as the image but with light blocked to reach the camera.
...
if __name__ == '__main__':
    ...
    image=loadImageCzi.ImageAICS(meta={'aics_filePath': imagePath})
    blackReference=loadImageCzi.ImageAICS(meta={'aics_filePath': blackReferencePath})
       
    rz=loadImageCzi.LoadImage()
    ...
    print 'Test correctBackground done'