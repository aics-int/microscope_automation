...
class ConnectMicroscope():
    ...
    def not_implemented(self, method_name):
        ...
        Output:
         none
        '''
        raise HardwareCommandNotDefinedError(method_name + ' is not supported for ZEN Black microscope')
    ...
    def get_stage_pos(self):
        ...
        try:
            ...
            raise HardwareError("Error in getting stage position (connect_zen_black.py).")
        return x, y
    ...
    def move_stage_to(self, xPos=None, yPos=None, test=False):
        ...
        try:
            ...
            raise HardwareError("Error in moving stage to position (connect_zen_black.py).")
        return xPos, yPos
    ...
    def find_surface(self):
        ...
        try:
            ...
            raise HardwareError("Error in finding surface using DF2 (connect_zen_black.py).")
        return z
    ...
    def get_focus_pos(self):
        ...
        try:
            ...
            raise HardwareError('Error in Getting position of the focus drive (connect_zen_black.py).')
        return z
    ...
    def move_focus_to(self, zPos):
        ...
        try:
            ...
            raise HardwareError('Error in Moving focus drive to a specified location (connect_zen_black.py).')
        return z_focus
    ...
    def save_image(self, fileName):
        ...
        try:
            ...
            log.exception(err)
            raise HardwareError('Error in saving image to path: {} in connect_zen_black.py.'.format(fileName))
    ...
    def z_relative_move(self, delta):
        ...
        try:
            ...
            raise HardwareError('Error in Relative movement of focus in the z direction (connect_zen_black.py).')
        return z
