...
#         rz.close()  Do not close Java VM!
    ...
    def execute_experiment(self, experiment):
        ...
        Image object is stored in self.imageAICS
        '''
    ...
    def get_stage_pos(self):
        ...
        '''
        xPos=float(raw_input('Enter x stage position: '))
        yPos=float(raw_input('Enter y stage position: '))
    ...
    def get_focus_pos(self):
        ...
        zPos = float(raw_input('Enter focus position: '))
        return zPos
