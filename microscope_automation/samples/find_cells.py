...
class CellFinder:
    ...
    def export_cells(self):
        ...
        for (ind, point) in enumerate(self.image_locations, start=1):
            ...
            cell_to_add = Cell(name=name, center=[x_pos, y_pos, 0], colony_object=self.colony_object)
    ...
    def adjust_image(self):
        ...
        if self.calibrate:
            ...
            if self.validate("Calibrate Contrast",
...
if __name__ == "__main__":
    start = time.time()
    segment_dir('/home/mattb/git/microscopeautomation/data/test_data_matthew/colony_seg_test/', False)  # noqa
