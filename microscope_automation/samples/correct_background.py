...
if __name__ == "__main__":
    ...
    if sys.platform == "darwin":
        ...
        output_original = (
            "//Users/winfriedw/Documents/ImageProcessing/original.tif"  # noqa
        )
        output_black_correction = (
            "//Users/winfriedw/Documents/ImageProcessing/blackCorrection.tif"  # noqa
        )
    ...
    imgScaled = (
        (
            (black_reference - black_reference.min())
    ...
    if testPatternCorrection:
        ...
        imgScaled = (
            (
                (patternCorrectedImage - patternCorrectedImage.min())
    ...
    if test_illumination_correction:
        illumination_corrected_image = illumination_correction(
            image, black_reference, illumination_reference
        )
        ...
        img_scaled = (
            (
                (illumination_corrected_image - illumination_corrected_image.min())
                / (
