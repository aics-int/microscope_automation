import pytest
import writeZENTilesExperiment




testclass = writeZENTilesExperiment.save_position_list(zsd="testZsd", plate=1234, production_path="testPath")
def test_init():
    # Check Type conversion
    assert isinstance(testclass.plate, str)
    # Check data fed into next step
    assert testclass.path == "testPath\\1234\\testZsd"
