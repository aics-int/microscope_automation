...
class Preferences:
    ...
    def __init__(self, prefPath=None, prefDict=None, parentPrefs=None):
        ...
        if prefPath is not None:
            ...
            with open(prefPath, 'r') as prefsFile:
                self.prefs = yaml.load(prefsFile)
    ...
    def getPref(self, name, validValues = None):
        ...
        '''
#         from .automationMessagesFormLayout import pull_down_select_dialog
        from automationMessagesFormLayout import pull_down_select_dialog
    ...
    def getPrefAsMeta(self, name):
        ...
        '''
        # To return dictionaries as object will help later if we want to implement some pre-processing and error checking of meta data.
